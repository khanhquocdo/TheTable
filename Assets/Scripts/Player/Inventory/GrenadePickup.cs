...
/// <summary>
/// Script cho Grenade Pickup - Player nhặt để thêm vào inventory
/// </summary>
[RequireComponent(typeof(Collider2D))]
public class GrenadePickup : MonoBehaviour
{
    [Header("Pickup Settings")]
    [SerializeField] private int amount = 1; // Số lượng grenade khi nhặt
    ...
    private void Pickup(GameObject player)
    {
        ...
        {
            Debug.LogError("GrenadePickup: Không tìm thấy InventorySystem!");
            return;
        }
        
        // Thêm vào inventory
        int addedAmount = InventorySystem.Instance.AddItem(WeaponType.Grenade, amount);
