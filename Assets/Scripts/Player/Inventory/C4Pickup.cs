...
/// <summary>
/// Script cho C4 Pickup - Player nhặt để thêm vào inventory
/// </summary>
[RequireComponent(typeof(Collider2D))]
public class C4Pickup : MonoBehaviour
{
    [Header("Pickup Settings")]
    [SerializeField] private int amount = 1; // Số lượng C4 khi nhặt
    ...
    private void Pickup(GameObject player)
    {
        ...
        {
            Debug.LogError("C4Pickup: Không tìm thấy InventorySystem!");
            return;
        }

        // Thêm vào inventory
        int addedAmount = InventorySystem.Instance.AddItem(WeaponType.C4, amount);
